...
const Analitics = ({ info, predictions, oddsHistory }) => {
    ...
    if (info.teams_form.home) {
        relevanceTeam = relevance(
            info.teams_form.home.matches,
            info.teams_form.away.matches
        );
    }
    ...
    return (
        <>
            <div className="container">
                ...
                <TeamStrength info={info} relevanceTeam={relevanceTeam} />
                <Motivation info={info} />
                <InjuredPlayers info={info} />
                <FieldFactor info={info} />
                <Facts info={info} />
                <Standings info={info} />
                <PredicitonsNbBet predictions={predictions} />
                <MoneyWay />
                <Predict
                    info={info}
