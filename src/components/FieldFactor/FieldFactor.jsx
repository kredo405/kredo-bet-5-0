                ...
                <div className="flex flex-col">
                    ...
                    <div className="flex">
                        <div className="flex flex-col items-center mr-3">
                            ...
                            <Progress
                                type="circle"
                                percent={percentHome.percentHome.toFixed(0)}
                                strokeColor={{
                                    "0%": "#108ee9",
                                    "100%": "#87d068",
                                }}
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <Progress
                                type="circle"
                                percent={percentHome.percentAway.toFixed(0)}
                                strokeColor={{
                                    "0%": "#108ee9",
                                    "100%": "#87d068",
                                }}
                ...
                <div className="flex flex-col">
                    ...
                    <div className="flex">
                        <div className="flex flex-col items-center mr-3">
                            ...
                            <Progress
                                type="circle"
                                percent={percentAway.percentHome.toFixed(0)}
                                strokeColor={{
                                    "0%": "#108ee9",
                                    "100%": "#87d068",
                                }}
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <Progress
                                type="circle"
                                percent={percentAway.percentAway.toFixed(0)}
                                strokeColor={{
                                    "0%": "#108ee9",
                                    "100%": "#87d068",
                                }}
