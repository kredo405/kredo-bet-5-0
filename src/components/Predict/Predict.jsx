...
const Predict = ({ info, predictions, outsiderRange, midleRange, grandRange, oddsHistory }) => {
    ...
    const handleClick = () => {
        ...
        const tableValue = {
            winnerHome: {
                ...
                summ() {
                    const h2h = this.percentagleH2h > 100 ? null : this.percentagleH2h
                    const score = correctScore.winnerHome ? correctScore.winnerHome : null
                    let sum
                    if (h2h && score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.winnerHome.percent + score)
                    } else if (h2h && !score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.winnerHome.percent + 50)
                    } else if (!h2h && score) {
                        sum = (this.percentageRank + 50 +
                            this.percentagleMatches + outcomes.winnerHome.percent + score)
                    }
            ...
            winnerAway: {
                ...
                summ() {
                    const h2h = this.percentagleH2h > 100 ? null : this.percentagleH2h
                    const score = correctScore.winnerAway ? correctScore.winnerAway : null
                    let sum
                    if (h2h && score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.winnerAway.percent + score)
                    } else if (h2h && !score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.winnerAway.percent + 50)
                    } else if (!h2h && score) {
                        sum = (this.percentageRank + 50 +
                            this.percentagleMatches + outcomes.winnerAway.percent + score)
                    }
            ...
            draw: {
                ...
                summ() {
                    ...
                    if (h2h && score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.draw.percent + score)
                    } else if (h2h && !score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.draw.percent + 50)
                    } else if (!h2h && score) {
                        sum = (this.percentageRank + 50 +
                            this.percentagleMatches + outcomes.draw.percent + score)
                    }
            ...
            winOrDrawHome: {
                ...
                summ() {
                    const h2h = this.percentagleH2h > 100 ? null : this.percentagleH2h
                    const score = correctScore.winOrDrawHome ? correctScore.winOrDrawHome : null
                    let sum
                    if (h2h && score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.winOrDrawHome.percent + score)
                    } else if (h2h && !score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.winOrDrawHome.percent + 50)
                    } else if (!h2h && score) {
                        sum = (this.percentageRank + 50 +
                            this.percentagleMatches + outcomes.winOrDrawHome.percent + score)
                    }
            ...
            winOrdrawAway: {
                ...
                summ() {
                    const h2h = this.percentagleH2h > 100 ? null : this.percentagleH2h
                    const score = correctScore.winOrdrawAway ? correctScore.winOrdrawAway : null
                    let sum
                    if (h2h && score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.winOrdrawAway.percent + score)
                    } else if (h2h && !score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.winOrdrawAway.percent + 50)
                    } else if (!h2h && score) {
                        sum = (this.percentageRank + 50 +
                            this.percentagleMatches + outcomes.winOrdrawAway.percent + score)
                    }
            ...
            foraHomeMinus15: {
                ...
                summ() {
                    const h2h = this.percentagleH2h > 100 ? null : this.percentagleH2h
                    const score = correctScore.foraHomeMinus15 ? correctScore.foraHomeMinus15 : null
                    let sum
                    if (h2h && score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.foraHomeMinus15.percent + score)
                    } else if (h2h && !score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.foraHomeMinus15.percent + 50)
                    } else if (!h2h && score) {
                        sum = (this.percentageRank + 50 +
                            this.percentagleMatches + outcomes.foraHomeMinus15.percent + score)
                    }
            ...
            foraHomePlus15: {
                ...
                summ() {
                    const h2h = this.percentagleH2h > 100 ? null : this.percentagleH2h
                    const score = correctScore.foraHomePlus15 ? correctScore.foraHomePlus15 : null
                    let sum
                    if (h2h && score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.foraHomePlus15.percent + score)
                    } else if (h2h && !score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.foraHomePlus15.percent + 50)
                    } else if (!h2h && score) {
                        sum = (this.percentageRank + 50 +
                            this.percentagleMatches + outcomes.foraHomePlus15.percent + score)
                    }
            ...
            foraAwayMinus15: {
                ...
                summ() {
                    const h2h = this.percentagleH2h > 100 ? null : this.percentagleH2h
                    const score = correctScore.foraAwayMinus15 ? correctScore.foraAwayMinus15 : null
                    let sum
                    if (h2h && score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.foraAwayMinus15.percent + score)
                    } else if (h2h && !score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.foraAwayMinus15.percent + 50)
                    } else if (!h2h && score) {
                        sum = (this.percentageRank + 50 +
                            this.percentagleMatches + outcomes.foraAwayMinus15.percent + score)
                    }
            ...
            foraAwayPlus15: {
                ...
                summ() {
                    const h2h = this.percentagleH2h > 100 ? null : this.percentagleH2h
                    const score = correctScore.foraAwayPlus15 ? correctScore.foraAwayPlus15 : null
                    let sum
                    if (h2h && score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.foraAwayPlus15.percent + score)
                    } else if (h2h && !score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.foraAwayPlus15.percent + 50)
                    } else if (!h2h && score) {
                        sum = (this.percentageRank + 50 +
                            this.percentagleMatches + outcomes.foraAwayPlus15.percent + score)
                    }
            ...
            to15: {
                ...
                summ() {
                    ...
                    if (h2h && score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.to15.percent + score)
                    } else if (h2h && !score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.to15.percent + 50)
                    } else if (!h2h && score) {
                        sum = (this.percentageRank + 50 +
                            this.percentagleMatches + outcomes.to15.percent + score)
                    }
            ...
            tu15: {
                ...
                summ() {
                    ...
                    if (h2h && score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.tu15.percent + score)
                    } else if (h2h && !score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.tu15.percent + 50)
                    } else if (!h2h && score) {
                        sum = (this.percentageRank + 50 +
                            this.percentagleMatches + outcomes.tu15.percent + score)
                    }
            ...
            to25: {
                ...
                summ() {
                    ...
                    if (h2h && score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.to25.percent + score)
                    } else if (h2h && !score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.to25.percent + 50)
                    } else if (!h2h && score) {
                        sum = (this.percentageRank + 50 +
                            this.percentagleMatches + outcomes.to25.percent + score)
                    }
            ...
            tu25: {
                ...
                summ() {
                    ...
                    if (h2h && score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.tu25.percent + score)
                    } else if (h2h && !score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.tu25.percent + 50)
                    } else if (!h2h && score) {
                        sum = (this.percentageRank + 50 +
                            this.percentagleMatches + outcomes.tu25.percent + score)
                    }
            ...
            to35: {
                ...
                summ() {
                    ...
                    if (h2h && score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.to35.percent + score)
                    } else if (h2h && !score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.to35.percent + 50)
                    } else if (!h2h && score) {
                        sum = (this.percentageRank + 50 +
                            this.percentagleMatches + outcomes.to35.percent + score)
                    }
            ...
            tu35: {
                ...
                summ() {
                    ...
                    if (h2h && score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.tu35.percent + score)
                    } else if (h2h && !score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.tu35.percent + 50)
                    } else if (!h2h && score) {
                        sum = (this.percentageRank + 50 +
                            this.percentagleMatches + outcomes.tu35.percent + score)
                    }
            ...
            btsYes: {
                ...
                summ() {
                    const h2h = this.percentagleH2h > 100 ? null : this.percentagleH2h
                    const score = correctScore.btsYes ? correctScore.btsYes : null
                    let sum
                    if (h2h && score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.btsYes.percent + score)
                    } else if (h2h && !score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.btsYes.percent + 50)
                    } else if (!h2h && score) {
                        sum = (this.percentageRank + 50 +
                            this.percentagleMatches + outcomes.btsYes.percent + score)
                    }
            ...
            btsNo: {
                ...
                summ() {
                    const h2h = this.percentagleH2h > 100 ? null : this.percentagleH2h
                    const score = correctScore.btsNo ? correctScore.btsNo : null
                    let sum
                    if (h2h && score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.btsNo.percent + score)
                    } else if (h2h && !score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.btsNo.percent + 50)
                    } else if (!h2h && score) {
                        sum = (this.percentageRank + 50 +
                            this.percentagleMatches + outcomes.btsNo.percent + score)
                    }
            ...
            it1O05: {
                ...
                summ() {
                    const h2h = this.percentagleH2h > 100 ? null : this.percentagleH2h
                    const score = correctScore.it1O05 ? correctScore.it1O05 : null
                    let sum
                    if (h2h && score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.it1O05.percent + score)
                    } else if (h2h && !score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.it1O05.percent + 50)
                    } else if (!h2h && score) {
                        sum = (this.percentageRank + 50 +
                            this.percentagleMatches + outcomes.it1O05.percent + score)
                    }
            ...
            it1O15: {
                ...
                summ() {
                    const h2h = this.percentagleH2h > 100 ? null : this.percentagleH2h
                    const score = correctScore.it1O15 ? correctScore.it1O15 : null
                    let sum
                    if (h2h && score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.it1O15.percent + score)
                    } else if (h2h && !score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.it1O15.percent + 50)
                    } else if (!h2h && score) {
                        sum = (this.percentageRank + 50 +
                            this.percentagleMatches + outcomes.it1O15.percent + score)
                    }
            ...
            it1O25: {
                ...
                summ() {
                    const h2h = this.percentagleH2h > 100 ? null : this.percentagleH2h
                    const score = correctScore.it1O25 ? correctScore.it1O25 : null
                    let sum
                    if (h2h && score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.it1O25.percent + score)
                    } else if (h2h && !score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.it1O25.percent + 50)
                    } else if (!h2h && score) {
                        sum = (this.percentageRank + 50 +
                            this.percentagleMatches + outcomes.it1O25.percent + score)
                    }
            ...
            it1U05: {
                ...
                summ() {
                    const h2h = this.percentagleH2h > 100 ? null : this.percentagleH2h
                    const score = correctScore.it1U05 ? correctScore.it1U05 : null
                    let sum
                    if (h2h && score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.it1U05.percent + score)
                    } else if (h2h && !score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.it1U05.percent + 50)
                    } else if (!h2h && score) {
                        sum = (this.percentageRank + 50 +
                            this.percentagleMatches + outcomes.it1U05.percent + score)
                    }
            ...
            it1U15: {
                ...
                summ() {
                    const h2h = this.percentagleH2h > 100 ? null : this.percentagleH2h
                    const score = correctScore.it1U15 ? correctScore.it1U15 : null
                    let sum
                    if (h2h && score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.it1U15.percent + score)
                    } else if (h2h && !score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.it1U15.percent + 50)
                    } else if (!h2h && score) {
                        sum = (this.percentageRank + 50 +
                            this.percentagleMatches + outcomes.it1U15.percent + score)
                    }
            ...
            it1U25: {
                ...
                summ() {
                    const h2h = this.percentagleH2h > 100 ? null : this.percentagleH2h
                    const score = correctScore.it1U25 ? correctScore.it1U25 : null
                    let sum
                    if (h2h && score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.it1U25.percent + score)
                    } else if (h2h && !score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.it1U25.percent + 50)
                    } else if (!h2h && score) {
                        sum = (this.percentageRank + 50 +
                            this.percentagleMatches + outcomes.it1U25.percent + score)
                    }
            ...
            it2O05: {
                ...
                summ() {
                    const h2h = this.percentagleH2h > 100 ? null : this.percentagleH2h
                    const score = correctScore.it2O05 ? correctScore.it2O05 : null
                    let sum
                    if (h2h && score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.it2O05.percent + score)
                    } else if (h2h && !score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.it2O05.percent + 50)
                    } else if (!h2h && score) {
                        sum = (this.percentageRank + 50 +
                            this.percentagleMatches + outcomes.it2O05.percent + score)
                    }
            ...
            it2O15: {
                ...
                summ() {
                    const h2h = this.percentagleH2h > 100 ? null : this.percentagleH2h
                    const score = correctScore.it2O15 ? correctScore.it2O15 : null
                    let sum
                    if (h2h && score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.it2O15.percent + score)
                    } else if (h2h && !score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.it2O15.percent + 50)
                    } else if (!h2h && score) {
                        sum = (this.percentageRank + 50 +
                            this.percentagleMatches + outcomes.it2O15.percent + score)
                    }
            ...
            it2O25: {
                ...
                summ() {
                    const h2h = this.percentagleH2h > 100 ? null : this.percentagleH2h
                    const score = correctScore.it2O25 ? correctScore.it2O25 : null
                    let sum
                    if (h2h && score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.it2O25.percent + score)
                    } else if (h2h && !score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.it2O25.percent + 50)
                    } else if (!h2h && score) {
                        sum = (this.percentageRank + 50 +
                            this.percentagleMatches + outcomes.it2O25.percent + score)
                    }
            ...
            it2U05: {
                ...
                summ() {
                    const h2h = this.percentagleH2h > 100 ? null : this.percentagleH2h
                    const score = correctScore.it2U05 ? correctScore.it2U05 : null
                    let sum
                    if (h2h && score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.it2U05.percent + score)
                    } else if (h2h && !score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.it2U05.percent + 50)
                    } else if (!h2h && score) {
                        sum = (this.percentageRank + 50 +
                            this.percentagleMatches + outcomes.it2U05.percent + score)
                    }
            ...
            it2U15: {
                ...
                summ() {
                    const h2h = this.percentagleH2h > 100 ? null : this.percentagleH2h
                    const score = correctScore.it2U15 ? correctScore.it2U15 : null
                    let sum
                    if (h2h && score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.it2U15.percent + score)
                    } else if (h2h && !score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.it2U15.percent + 50)
                    } else if (!h2h && score) {
                        sum = (this.percentageRank + 50 +
                            this.percentagleMatches + outcomes.it2U15.percent + score)
                    }
            ...
            it2U25: {
                ...
                summ() {
                    const h2h = this.percentagleH2h > 100 ? null : this.percentagleH2h
                    const score = correctScore.it2U25 ? correctScore.it2U25 : null
                    let sum
                    if (h2h && score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.it2U25.percent + score)
                    } else if (h2h && !score) {
                        sum = (this.percentageRank + h2h +
                            this.percentagleMatches + outcomes.it2U25.percent + 50)
                    } else if (!h2h && score) {
                        sum = (this.percentageRank + 50 +
                            this.percentagleMatches + outcomes.it2U25.percent + score)
                    }
        ...
        for (const key in tableValue) {
            ...
            if (tableValue[key].odd >= 1.4) {
                resultObj[key] = {
                    ...
                    percentaglePredictions: tableValue[key].percentaglePredictions,
        ...
        const sorted = Object.entries(resultObj).sort((a, b) => b[1].sum - a[1].sum).slice(0, 5);
        ...
        const table = result.map(el => { 
            ...
            const oddElements = oddsHistory[element.num].map(el => {
                ...
                return (
                    <div key={el[0]} className="flex justify-between items-center border-b-2 border-slate-400 border-solid px-3">
                        <div className="font-bold text-lime-900 ">{date}</div>
                        <div className="font-bold text-cyan-800">{el[1].toFixed(2)}</div>
                    </div>
                )
            })
            ...
            return (
                <div className="mb-3" key={element.num}>
                    <div className="flex justify-center py-3 w-full bg-slate-100">
                        <span className="text-lg font-bold font-mono">{element.name}</span>
                    </div>
                    <div>
                        <Tabs
                            ...
                            <Tab eventKey={element.name} title="Основное">
                               <div>
                                <div className="flex justify-between items-center border-b-2 border-slate-400 border-solid">
                                    <div className="font-bold text-lime-900 ">Вероятность</div>
                                    <div className="font-bold text-red-800">{element.percent.toFixed(1)}%</div>
                                </div>
                                <div className="flex justify-between items-center border-b-2 border-slate-400 border-solid">
                                    <div className="font-bold text-lime-900 ">Рейтинг</div>
                                    <div className="font-bold text-red-800">{element.sum.toFixed(1)}</div>
                                </div>
                                <div className="flex justify-between items-center border-b-2 border-slate-400 border-solid">
                                    <div className="font-bold text-lime-900 ">Кол-во прогнозов</div>
                                    <div className="font-bold text-red-800">{element.percentaglePredictions}</div>
                                </div>
                                <div className="flex justify-between items-center border-b-2 border-slate-400 border-solid">
                                    <div className="font-bold text-lime-900 ">Коэфицент</div>
                                    <div className="font-bold text-red-800">{element.odd.toFixed(1)}</div>
                                </div>
                                <div className="flex justify-between items-center border-b-2 border-slate-400 border-solid">
                                    <div className="font-bold text-lime-900 ">Валуйность</div>
                                    <div className="font-bold text-red-800">{((element.percent) - (100 / element.odd)).toFixed(1)}%</div>
                                </div>
                                <div className="flex justify-between items-center border-b-2 border-slate-400 border-solid">
                                    <div className="font-bold text-lime-900 ">Прошёл в матчах%</div>
                                    <div className="font-bold text-red-800">{element.percentagleMatches.toFixed(1)}%</div>
                                </div>
                                <div className="flex justify-between items-center border-b-2 border-slate-400 border-solid">
                                    <div className="font-bold text-lime-900 ">Прошёл в матчах H2H%</div>
                                    <div className="font-bold text-red-800">{element.percentagleH2h.toFixed(1)}%</div>
                                </div>
                                <div className="flex justify-between items-center border-b-2 border-slate-400 border-solid">
                                    <div className="font-bold text-lime-900 ">Прошёл c пох. командами</div>
                                    <div className="font-bold text-red-800">{element.percentageRank.toFixed(1)}%</div>
                                </div>
                               </div>
                            </Tab>
                            <Tab eventKey={element.num} title="История Коэфицентов">
                            <div>
                                {oddElements}
                            </div>
                            </Tab>
