    ...
    return (
        <>
            <div className="min-h-full flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
                ...
                <div className="mt-3">
                    <h2 className="text-center font-sans text-xl font-semibold text-slate-800">
                        Или войдите с помощью
                    </h2>
                    <div className="flex mt-3">
                        <button className="px-3" onClick={googleAuth}>
                            <img
                                className="w-[55px]"
                        ...
                        <button className="px-3" onClick={facebookAuth}>
                            <img
                                className="w-[55px]"
                        ...
                        <button className="px-3" onClick={gitHubAuth}>
                            <img
                                className="w-[55px]"
