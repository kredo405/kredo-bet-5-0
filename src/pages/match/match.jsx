                    ...
                    <div className="flex justify-evenly item-center">
                        ...
                        <div className="flex justify-center items-center w-2/12 mb-10">
                            <span className="text-2xl">
                                {info.goals.lenght > 0 ? info.goals[0] : "-"}:
                                {info.goals.lenght > 0 ? info.goals[1] : "-"}
                            </span>
                        </div>
                        <div className="flex flex-col items-center w-5/12 ">
                            <img
                    ...
                    <div className="flex flex-col  my-5">
                        <div>
                            ...
                            <span className="text-teal-900 text-start font-mono w-[50%]">
                                {info.additional_info.stadium_name
                                    ? info.additional_info.stadium_name
                                    : "Нет информации"}
                            </span>
                        </div>
                        <div className="w-[50%]">
                            ...
                            <span
                                className={
                                    info.additional_info?.temperature?.slice(
                                        0,
                                        1
                                    ) === "+"
                                        ? +info.additional_info?.temperature?.slice(
                                            ...
                                            ? "text-orange-500 text-center font-bold"
                                            : "text-cyan-600 text-center font-bold"
                                        : "text-sky-400 text-center font-bold"
                                }
                            >
                                {info.additional_info?.temperature
                                    ? info.additional_info?.temperature
                                    : "Нет информации"}
                            </span>
                            <span className="text-teal-900 text-end font-mono pl-3">
                                {info.additional_info?.weather
                                    ? info.additional_info?.weather
                                    : "Нет информации"}
                            </span>
                        </div>
                    ...
                    <div className="mt-5 mb-5">
                        ...
                        >
                            <Tab
                                eventKey="predict"
                                title={
                                    <p className="shadow-cyan-200font-mono font-medium text-indigo-900">
                                        Статистика
                                    </p>
                                }
                            >
