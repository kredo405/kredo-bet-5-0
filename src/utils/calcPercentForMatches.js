export const calPercentForMatches = (
    matchesHome,
    matchesAway,
    homeName,
    awayName
    ...
    outcomes["Match Winner"].home =
        (outcomes["Match Winner"].home * 100) / quntityMatchesHome;
    outcomes["Match Winner"].away =
        (outcomes["Match Winner"].away * 100) / quntityMatchesAway;
    outcomes["Draw"].home = (outcomes["Draw"].home * 100) / quntityMatchesHome;
    outcomes["Draw"].away = (outcomes["Draw"].away * 100) / quntityMatchesAway;
    outcomes["Asian Handicap"]["handicap -1.5"].home =
        (outcomes["Asian Handicap"]["handicap -1.5"].home * 100) /
        quntityMatchesHome;
    outcomes["Asian Handicap"]["handicap -1.5"].away =
        (outcomes["Asian Handicap"]["handicap -1.5"].away * 100) /
        quntityMatchesAway;
    outcomes["Asian Handicap"]["handicap +1.5"].home =
        (outcomes["Asian Handicap"]["handicap +1.5"].home * 100) /
        quntityMatchesHome;
    outcomes["Asian Handicap"]["handicap +1.5"].away =
        ...
        quntityMatchesAway;
    outcomes["Goals Over/Under"]["Over 1.5"].home =
        (outcomes["Goals Over/Under"]["Over 1.5"].home * 100) /
        quntityMatchesHome;
    outcomes["Goals Over/Under"]["Over 1.5"].away =
        (outcomes["Goals Over/Under"]["Over 1.5"].away * 100) /
        quntityMatchesAway;
    outcomes["Goals Over/Under"]["Over 2.5"].home =
        (outcomes["Goals Over/Under"]["Over 2.5"].home * 100) /
        quntityMatchesHome;
    outcomes["Goals Over/Under"]["Over 2.5"].away =
        (outcomes["Goals Over/Under"]["Over 2.5"].away * 100) /
        quntityMatchesAway;
    outcomes["Goals Over/Under"]["Over 3.5"].home =
        (outcomes["Goals Over/Under"]["Over 3.5"].home * 100) /
        quntityMatchesHome;
    outcomes["Goals Over/Under"]["Over 3.5"].away =
        (outcomes["Goals Over/Under"]["Over 3.5"].away * 100) /
        quntityMatchesAway;
    outcomes["Goals Over/Under"]["Under 3.5"].home =
        (outcomes["Goals Over/Under"]["Under 3.5"].home * 100) /
        quntityMatchesHome;
    outcomes["Goals Over/Under"]["Under 3.5"].away =
        (outcomes["Goals Over/Under"]["Under 3.5"].away * 100) /
        quntityMatchesAway;
    outcomes["Goals Over/Under"]["Under 2.5"].home =
        (outcomes["Goals Over/Under"]["Under 2.5"].home * 100) /
        quntityMatchesHome;
    outcomes["Goals Over/Under"]["Under 2.5"].away =
        (outcomes["Goals Over/Under"]["Under 2.5"].away * 100) /
        quntityMatchesAway;
    outcomes["Goals Over/Under"]["Under 1.5"].home =
        (outcomes["Goals Over/Under"]["Under 1.5"].home * 100) /
        quntityMatchesHome;
    outcomes["Goals Over/Under"]["Under 1.5"].away =
        (outcomes["Goals Over/Under"]["Under 1.5"].away * 100) /
        quntityMatchesAway;
    outcomes["Both Teams Score"].Yes.home =
        (outcomes["Both Teams Score"].Yes.home * 100) / quntityMatchesHome;
    outcomes["Both Teams Score"].Yes.away =
        (outcomes["Both Teams Score"].Yes.away * 100) / quntityMatchesAway;
    outcomes["Both Teams Score"].No.home =
        (outcomes["Both Teams Score"].No.home * 100) / quntityMatchesHome;
    outcomes["Both Teams Score"].No.away =
        (outcomes["Both Teams Score"].No.away * 100) / quntityMatchesAway;
    outcomes["individualTotal"]["Over 0.5"].home =
        (outcomes["individualTotal"]["Over 0.5"].home * 100) /
        quntityMatchesHome;
    outcomes["individualTotal"]["Over 0.5"].away =
        (outcomes["individualTotal"]["Over 0.5"].away * 100) /
        quntityMatchesAway;
    outcomes["individualTotal"]["Over 1.5"].home =
        (outcomes["individualTotal"]["Over 1.5"].home * 100) /
        quntityMatchesHome;
    outcomes["individualTotal"]["Over 1.5"].away =
        (outcomes["individualTotal"]["Over 1.5"].away * 100) /
        quntityMatchesAway;
    outcomes["individualTotal"]["Over 2.5"].home =
        (outcomes["individualTotal"]["Over 2.5"].home * 100) /
        quntityMatchesHome;
    outcomes["individualTotal"]["Over 2.5"].away =
        (outcomes["individualTotal"]["Over 2.5"].away * 100) /
        quntityMatchesAway;
    outcomes["individualTotal"]["Under 0.5"].home =
        (outcomes["individualTotal"]["Under 0.5"].home * 100) /
        quntityMatchesHome;
    outcomes["individualTotal"]["Under 0.5"].away =
        (outcomes["individualTotal"]["Under 0.5"].away * 100) /
        quntityMatchesAway;
    outcomes["individualTotal"]["Under 1.5"].home =
        (outcomes["individualTotal"]["Under 1.5"].home * 100) /
        quntityMatchesHome;
    outcomes["individualTotal"]["Under 1.5"].away =
        (outcomes["individualTotal"]["Under 1.5"].away * 100) /
        quntityMatchesAway;
    outcomes["individualTotal"]["Under 2.5"].home =
        (outcomes["individualTotal"]["Under 2.5"].home * 100) /
        quntityMatchesHome;
    outcomes["individualTotal"]["Under 2.5"].away =
        (outcomes["individualTotal"]["Under 2.5"].away * 100) /
        quntityMatchesAway;
