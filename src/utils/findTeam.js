const findTeam = (name1, name2) => {
    ...
    if (arrTeamNameHyphen1[1] && arrTeamNameSpace2[1]) {
        if (
            arrTeamNameHyphen1[0].toLowerCase() ===
                arrTeamNameSpace2[0].toLowerCase() &&
            arrTeamNameHyphen1[1].toLowerCase() ===
                arrTeamNameSpace2[1].toLowerCase()
        ) {
            return true;
        }
    }
    ...
    if (arrTeamNameHyphen2[1] && arrTeamNameSpace1[1]) {
        if (
            arrTeamNameHyphen2[0].toLowerCase() ===
                arrTeamNameSpace1[0].toLowerCase() &&
            arrTeamNameHyphen2[1].toLowerCase() ===
                arrTeamNameSpace1[1].toLowerCase()
        ) {
            return true;
        }
    }
    ...
    if (arrTeamNameSpace1.length > 1 && arrTeamNameSpace2.length > 1) {
        if (
            arrTeamNameSpace1[0].toLowerCase() ===
                arrTeamNameSpace2[0].toLowerCase() &&
            arrTeamNameSpace1[1][0].toLowerCase() ===
                arrTeamNameSpace2[1][0].toLowerCase()
        ) {
            return true;
        }
    }
    if (arrTeamNameSpace1.length === 1 && arrTeamNameSpace2.length === 2) {
        if (
            (arrTeamNameSpace1[0].toLowerCase() ===
                arrTeamNameSpace2[1].toLowerCase() &&
                arrTeamNameSpace2[0].toLowerCase() === "club") ||
            (arrTeamNameSpace1[0].toLowerCase() ===
                arrTeamNameSpace2[1].toLowerCase() &&
                arrTeamNameSpace2[0].toLowerCase() === "fc")
        ) {
            return true;
        }
    }
    ...
    if (arrTeamNameSpace1.length === 2 && arrTeamNameSpace2.length === 1) {
        ...
        arrTeamNameSpace1.length === 1 &&
        arrTeamNameSpace2.length === 2
    ) {
        if (
            arrTeamNameSpace1[0].toLowerCase() ===
                arrTeamNameSpace2[0].toLowerCase() ||
    ...
    if (arrTeamNameSpace1.length === 2 && arrTeamNameSpace2.length === 2) {
        if (
            ...
            if (
                arrTeamName1[0].toLowerCase() ===
                    arrTeamName2[0].toLowerCase() &&
                arrTeamName1[1].toLowerCase() ===
                    arrTeamName2[1].toLowerCase() &&
    ...
    if (
        name1.toLowerCase() === "wolves" &&
        name2.toLowerCase() === "wolverhampton wanderers"
    ) {
        return true;
    }
    return false;
