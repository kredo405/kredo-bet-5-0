const findTeam = (name1, name2) => {
    ...
    if (arrTeamNameSpace1.length > 1 && arrTeamNameHyphen1.length < 3 && arrTeamNameSpace2.length > 1 && arrTeamNameSpace2.length < 3) {
    ...
    // if (arrTeamNameHyphen1.length < 2 && arrTeamNameSpace2.length > 1 || arrTeamNameHyphen1.length < 2 && arrTeamNameHyphen1.length > 1) {
    ...
    //     }
    // }
    if (arrTeamNameHyphen1.length > 1 && arrTeamNameHyphen1.length < 3 && arrTeamNameSpace2.length > 1 && arrTeamNameSpace2.length < 3) {
    ...
    if (arrTeamNameHyphen1.length === 3 && arrTeamNameSpace2.length === 3) {
